...
const u32 gTrainerFrontPic_Idol[] = INCBIN_U32("graphics/trainers/front_pics/Idol_front_pic.4bpp.lz");
const u32 gTrainerPalette_Idol[] = INCBIN_U32("graphics/trainers/palettes/Idol.gbapal.lz");
